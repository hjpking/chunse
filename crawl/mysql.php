<?php
define('HOSTNAME', '211.100.40.57'); //服务器地址
define('USERNAME', 'root'); //数据库用户名
define('PASSWORD', '123456'); //数据库密码
define('DATABASE', 'chunse'); //数据库名称
define('CHARSET', 'utf8'); //数据库编码
define('PCONNECT', '1'); //开启持久连接
define('LOG', '1'); //开启日志
define('LOGFILEPATH', './'); //开启日志
...
class mysql
{
    ...
    public function __construct()
    {
        ...
        $this->connect(HOSTNAME, USERNAME, PASSWORD, DATABASE, PCONNECT);
        $this->is_log = LOG;
        if ($this->is_log) {
