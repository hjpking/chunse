...
<?php include_once libfile('function/ftn');
...
//qqdl
$qqdlurl = make_qqdl_url($attach['sha1'],$attach['filename']);?><?php
$return = <<<EOF
...
EOF;
 } if($attach['sha1'] && (!$attach['price'] || $attach['payed'])) { 
$return .= <<<EOF

<script type='text/javascript'>
appendscript('http://x.soso.com/js/xf/xflib.js','','','utf-8');
</script>
<style type="text/css">.tattl {height:84px;}</style>
<p class="xg2"><a href="javascript:;" QHref="{$qqdlurl}" class="ftn_qqdl" onclick="OnDownloadClick_Simple(this, event, 21504);ajaxget('forum.php?mod=attachment{$is_archive}&aid={$aidencode}','','',null,null);return false;" oncontextmenu="OnContextClick(this, event)">旋风高速下载</a></p>
...
<a href="javascript:;" QHref="{$qqdlurl}" class="ftn_qqdl" onclick="OnDownloadClick_Simple(this, event, 21504);ajaxget('forum.php?mod=attachment{$is_archive}&aid={$aidencode}','','',null,null);return false;" oncontextmenu="OnContextClick(this, event)">旋风高速下载</a><br>
